            ...
            <div class="card w-100">
                <div class="card-body p-4">
                    <div class="d-flex mb-4 justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#createFasilitasModal">Tambah Fasilitas</button>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-warning btn-sm" onclick="openEditModal({{ $item }})">
        ...
        <div class="modal-content">
            <form action="{{ route('fasilitas.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="namaTokoCreate" class="form-label">Nama Toko</label>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="editFasilitasForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="namaTokoEdit" class="form-label">Nama Toko</label>
