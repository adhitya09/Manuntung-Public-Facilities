...
<body class="index-page">
      ...
      <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
          ...
          <a class="btn-outline" href="#hero">Akun</a>
        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="park-details">
                    ...
                    <p><i class="bi bi-geo-alt"></i> Jl. Jenderal Sudirman No.86, RT.11, Damai, Kec. Balikpapan, Kalimantan Timur 76114</p>
                </div>
            ...
            <div class="card">
                ...
                <div class="park-details">
                    <p><i class="bi bi-clock"></i> Buka 24 jam</p>
                    <p><i class="bi bi-geo-alt"></i> Jl. Jermuri 1 Sepinggan, Kecamatan Balikpapan Selatan, Kota Balikpapan</p>
                </div>
                <div class="tracking-button">
                    <a href="#" class="btn-tracking">
                    <img src="assets/img/titik.png" alt="Tracking Icon" class="tracking-icon">
            ...
            <div class="card">
                ...
                <div class="park-details">
                    <p><i class="bi bi-clock"></i> Buka 24 jam</p>
                    <p><i class="bi bi-geo-alt"></i> Jl. P. Antasari, Karang Rejo, Kota Balikpapan, Kalimantan Timur 76113</p>
                </div>
                <div class="tracking-button">
                    <a href="#" class="btn-tracking">
                    <img src="assets/img/titik.png" alt="Tracking Icon" class="tracking-icon">
