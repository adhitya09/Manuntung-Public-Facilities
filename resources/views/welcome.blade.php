...
<head>
  ...
  <title>Selamat Datang - Manuntung Public Facilities</title>
...
<body class="index-page">
      ...
      <header id="header" class="header d-flex align-items-center fixed-top">
        ...
        <body>
          <a class="btn-outline" href="#hero" id="akunButton">Akun</a>
          ...
          <script>
            ...
            akunButton.addEventListener('click', function(event) {
              ...
              alert("Eitss sabar yaa, belum dibuat hehe!");
            });
          </script>
        </body>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-7 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
              <div class="content">
                ...
                <p style="font-size: 1.25rem; line-height: 1.8;">
                  Aplikasi yang mempermudah pengguna untuk melacak lokasi fasilitas umum di Kota Balikpapan.
                  Dengan aplikasi ini, pengguna dapat mengetahui lokasi keberadaan mereka dan arah menuju fasilitas umum
            ...
            <div class="col-lg-5 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
              <img src="assets/img/maps.png" class="img-fluid" alt="Maps Image" style="max-width: 100%; height: auto;">
            </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
              ...
              <h3>Taman</h3>
              <p>Tempat untuk bersantai dan menikmati suasana alam kota. Cocok untuk jalan-jalan ringan atau sekadar duduk santai.</p>
            </div>
          </div><!-- End Card Item -->
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              ...
              <p>Fasilitas olahraga yang bisa digunakan warga, termasuk lapangan dan area kebugaran untuk aktivitas fisik.</p>
            </div>
          </div><!-- End Card Item -->
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              ...
              <p>Tempat untuk membaca dan menambah wawasan dengan suasana tenang serta pilihan buku yang beragam.</p>
            </div>
          </div><!-- End Card Item -->
